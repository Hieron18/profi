...
setTimeout( function(){
   var typed = new Typed('.repair__anim', {
      strings: ['По фиксированной цене ',
               'С выездом на дом ',
               'Любой сложности ',
      ],
      typeSpeed: 60,
...
let slider_about = new Swiper('.master__swiper', {
	// effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	// Arrows
	navigation: {
		nextEl: '.master__item_next',
		prevEl: '.master__item_prev',
	},
	/*
	breakpoints: {
		320: {
...
let slider_about2 = new Swiper('.profes__swiper', {
	// effect: 'fade',
	// autoplay: {
	// 	delay: 2000,
	// 	disableOnInteraction: false,
	...
	// Arrows
	navigation: {
		nextEl: '.profes__item_next',
		prevEl: '.profes__item_prev',
	},
...
const headerContent = document.querySelector(".header-hide");
   const headerFirst = document.querySelectorAll(".header-view");
   const headerHeight = headerContent.offsetHeight;
   let lastScrollTop = 0;

   window.addEventListener('scroll', function(){
		let scrollDis = window.scrollY;
		headerFirst.forEach((elem) => {
			let headerFirstHeight = elem.offsetHeight;
			if(scrollDis > headerFirstHeight + 0){
					headerContent.classList.add('header__fixed');
					elem.classList.add('headerFirst');
					elem.style.paddingTop = `${headerHeight}px`;
			} else {
					if(headerContent.classList.contains('header__fixed')){
							headerContent.classList.add('header__fixed_back');
							setTimeout(function(){
									elem.classList.remove('headerFirst')
									headerContent.classList.remove('header__fixed_back');
									headerContent.classList.remove('header__fixed');
